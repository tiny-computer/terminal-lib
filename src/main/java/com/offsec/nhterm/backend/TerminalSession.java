...
public class TerminalSession extends TerminalOutput {
  ...
  /**
   * Initialize resources for string localization.
   * Call this from Application.onCreate() or early initialization.
   */
  ...
  public void initializeEmulator(int columns, int rows) {
    mEmulator = new TerminalEmulator(this, columns, rows, /* transcript= */4096);
  ...
  protected String getExitDescription(int exitCode) {
    if (sResources != null) {
      ...
      sb.append(sResources.getString(R.string.process_exit_info));
      if (exitCode > 0) {
        sb.append(" (");
        sb.append(sResources.getString(R.string.process_exit_code, exitCode));
        sb.append(")");
      } else if (exitCode < 0) {
        sb.append(" (");
        sb.append(sResources.getString(R.string.process_exit_signal, -exitCode));
        sb.append(")");
      }
      sb.append(" - ");
      sb.append(sResources.getString(R.string.process_exit_prompt));
      sb.append("]");
      return sb.toString();
    }

    // Fallback if resources are not initialized
