        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
          ...
          switch (item.getItemId()) {
            ...
            case 2:
              ...
              break;
            case 3:
              PopupMenu popup = new PopupMenu(getContext(), TerminalView.this);
              popup.getMenu().add(Menu.NONE, 4, Menu.NONE, R.string.copy_all_text);
              popup.getMenu().add(Menu.NONE, 5, Menu.NONE, R.string.show_keyboard);
              popup.setOnMenuItemClickListener(menuItem -> {
                switch (menuItem.getItemId()) {
                  case 4:
                    String allText = mEmulator.getScreen().getTranscriptText();
                    mTermSession.clipboardText(allText);
                    break;
                  case 5:
              ...
              popup.show();
              return true; // Don't fall through to toggleSelectingText; handled in popup callback
          }
          toggleSelectingText(null);
          return true;
        }
