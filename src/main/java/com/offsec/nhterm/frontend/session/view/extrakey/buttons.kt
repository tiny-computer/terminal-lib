...
abstract class IExtraButton : View.OnClickListener {
  ...
  companion object {
    ...
    var terminalViewProvider: (() -> TerminalView?)? = null
    ...
    fun sendKey(view: View, keyName: String) {
      ...
      when (keyName) {
        ...
        KEY_DEL -> keyCode = KeyEvent.KEYCODE_FORWARD_DEL
      ...
      if (keyCode > 0) {
        ...
        val terminalView = terminalViewProvider?.invoke()
...
open class RepeatableButton(buttonText: String) : ControlButton(buttonText) {
  ...
  private class RepeatableButtonWidget(context: Context?, attrs: AttributeSet?, defStyleAttr: Int) :
    ...
    var mHandler: android.os.Handler = object : android.os.Handler(android.os.Looper.getMainLooper()) {
